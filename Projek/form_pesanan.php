    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center">
                ...
                <h2 data-aos="fade-up" data-aos-delay="400">Silahkan Isi Form di bawah ini!</h2>
                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 d-flex justify-content-end">
                            <input type="submit" name="proces" type="submit" class="btn btn-primary me-1 mb-1" value="Simpan" />
                        </div>
                    </div>
                </div>
            </form>
